...
if __name__ == "__main__":
    ...
    # and save
    fig.tight_layout()
    fig.savefig("{}_layout.png".format(df.iloc[0]["name"].replace("_","")), transparent=False, bbox_inches='tight')
    fig.savefig("{}_transparent_layout.png".format(df.iloc[0]["name"].replace("_","")), transparent=True, bbox_inches='tight')
    plt.show()
